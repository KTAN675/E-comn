...
class WalletRewardsRow extends StatelessWidget {
  ...
  const WalletRewardsRow({super.key, required this.ctrl});
          ...
          Expanded(
            child: Container(
              ...
              child: Row(
                children: [
                  Image.asset(
                    'assets/images/wallet/Yellow Five Pointed Star.png', // your star asset
                    width: 28,
                    height: 28,
                    errorBuilder: (context, error, stackTrace) {
                      return const Icon(Icons.star, size: 28, color: Colors.orange);
                    },
                  ),
                  const SizedBox(width: 12),
                  Expanded(
