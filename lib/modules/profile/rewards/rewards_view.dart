...
class RewardsView extends GetView<RewardsController> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("View All >", style: AppTextStyles.bodyGrey),
                  ],
                ),
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return rewardCard(reward: reward, accent: accent); // ✅
                  },
                ),
              ],
            ),
  ...
  Widget rewardTask({
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: accent, size: 28), // ✅ Dynamic
  ...
  /// REWARD CARD
  Widget rewardCard({
    required Map<String, String> reward,
    required Color accent, // ✅
  }) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Column(
            children: [
              Text(reward["title"]!, style: AppTextStyles.h2),
