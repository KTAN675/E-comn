  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<WishlistController>(
      builder: (wishlist) {
        ...
        final bool isFavorite = wishlist.isWishlisted(product); // ✅ Controller se
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          wishlist.toggleWishlist(product); // ✅ Controller se toggle
                        ...
                        child: Container(
                          ...
                          child: Icon(
                            isFavorite
                                ? Icons.favorite
                                : Icons.favorite_border, // ✅ Controller se
                            color: Colors.white,
                            size: 20,
                          ),
                        ),
